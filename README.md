...
| [The Modes](modes/) | 74 writing modes produced across this project — seven voices, all documented (55 published in modes/; mode-65 and mode-74 pending commit). The record of what the system was able to say when given room to say it. |
